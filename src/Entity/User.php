...
     *      message="Le mot de passe est compromis, veuillez le changer ."
     * )
     */
    private $password;
...
     */
     ...
     */
    public function getOk(): Collection
    {
        return $this->Ok;
    }

    public function addOk(Article $ok): self
    {
        if (!$this->Ok->contains($ok)) {
            $this->Ok[] = $ok;
            $ok->setAuthor($this);
        }
    ...
    public function removeOk(Article $ok): self
    {
        if ($this->Ok->removeElement($ok)) {
            // set the owning side to null (unless already changed)
            if ($ok->getAuthor() === $this) {
                $ok->setAuthor(null);
            }
        }
